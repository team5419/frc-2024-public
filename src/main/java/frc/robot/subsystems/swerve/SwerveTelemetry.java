...
public class SwerveTelemetry {
    ...
    NetworkTable table = inst.getTable("Swerve/Pose");
    DoubleArrayPublisher fieldPub = table.getDoubleArrayTopic("Robot Pose").publish();
    StringPublisher fieldTypePub = table.getStringTopic(".type").publish();

    /* Robot speeds for general checking */
    NetworkTable driveStats = inst.getTable("Swerve/Speeds");
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        fieldTypePub.set("Swerve/Field2d");
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            // SmartDashboard.putNumber("Module #" + i + " current", TunerConstants.Swerve.getModule(i).getDriveMotor().getStatorCurrent().getValueAsDouble());
            // SmartDashboard.putNumber("Module #" + i + " Temperature ", TunerConstants.Swerve.getModule(i).getDriveMotor().getDeviceTemp().getValueAsDouble());
        }
    }
}
